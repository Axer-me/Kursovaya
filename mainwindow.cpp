...
void MainWindow::on_pushButton_3_clicked()
{
    ...
    int height = ui ->spinBox -> text().toInt(0,10);
    int weight = ui ->spinBox_2 -> text().toInt(0,10) ;
    int time = ui -> spinBox_3 -> text().toInt(0,10);
    int distance = ui ->spinBox_4 -> text().toInt(0,10);
